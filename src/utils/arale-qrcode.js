export const AraleQRCode = (function (t) {
  function e(o) {
  ...
  function (t, e, r) {
    ...
    var o = r(4),
      ...
      s = function (t) {
        ...
        return e.pdground &&
          ((t.row > 1 && t.row < 5 && t.col > 1 && t.col < 5) ||
            (t.row > t.count - 6 && t.row < t.count - 2 && t.col > 1 && t.col < 5) ||
            (t.row > 1 && t.row < 5 && t.col > t.count - 6 && t.col < t.count - 2))
          ? e.pdground
          : e.foreground
      },
      u = function (t) {
      ...
      a = function (t) {
        ...
        for (var e = null, r = 0, s = i.length; s > r; r++)
          if (
            i[r].text == this.options.text &&
            i[r].text.correctLevel == this.options.correctLevel
          ) {
            e = i[r].obj
            break
          }
        if (
          (r == s &&
            ((e = new n(this.options.text, this.options.correctLevel)),
            i.push({ text: this.options.text, correctLevel: this.options.correctLevel, obj: e })),
          this.options.render)
        )
    ...
    o(a.prototype, {
      createDefault: function (t) {
        ...
        return document.createElementNS && document.createElementNS(r, 'svg').createSVGRect
          ? this.createSVG(t)
          : this.createTable(t)
      },
      ...
      createTable: function (t) {
        ...
        if ((n.push('</table>'), e.image)) {
          ...
          n.unshift("<div style='position:relative; width:" + h + 'px; height:' + g + "px;'>"),
            n.push(
              "<img src='" +
                e.image +
                "' width='" +
  ...
  function (t, e) {
    ...
    function r(t) {
      ...
      return 128 > t
        ? [t]
        : 2048 > t
        ? ((e = 192 + (t >> 6)), (r = 128 + (63 & t)), [e, r])
        : ((e = 224 + (t >> 12)), (r = 128 + ((t >> 6) & 63)), (o = 128 + (63 & t)), [e, r, o])
    }
    function o(t) {
      for (var e = [], o = 0; o < t.length; o++)
        for (var i = t.charCodeAt(o), n = r(i), s = 0; s < n.length; s++) e.push(n[s])
      return e
    }
    function i(t, e) {
      ;(this.typeNumber = -1),
    ...
    ;(i.prototype = {
      ...
      setupTypeInfo: function (t, e) {
        for (
          var r = (u[this.errorCorrectLevel] << 3) | e, o = l.getBCHTypeInfo(r), i = 0;
          15 > i;
          i++
        ) {
          var n = !t && 1 == ((o >> i) & 1)
      ...
      createBytes: function (t) {
        for (
          var e = 0, r = 0, o = 0, i = this.rsBlock.length / 3, s = new Array(), u = 0;
          i > u;
          u++
        )
          for (
            var a = this.rsBlock[3 * u + 0],
              h = this.rsBlock[3 * u + 1],
              g = this.rsBlock[3 * u + 2],
              c = 0;
            a > c;
            c++
          )
        ...
        for (var P = new Array(this.totalDataCount), y = 0, u = 0; r > u; u++)
          for (var m = 0; m < s.length; m++) u < f[m].length && (P[y++] = f[m][u])
        for (var u = 0; o > u; u++)
          for (var m = 0; m < s.length; m++) u < d[m].length && (P[y++] = d[m][u])
        return P
      },
      mapData: function (t, e) {
        for (
          var r = -1, o = this.moduleCount - 1, i = 7, n = 0, s = this.moduleCount - 1;
          s > 0;
          s -= 2
        )
          for (6 == s && s--; ; ) {
    ...
    ;(i.prototype.getRightType = function () {
      for (var t = 1; 41 > t; t++) {
        ...
        if (void 0 == e)
          throw new Error(
            'bad rs block @ typeNumber:' + t + '/errorCorrectLevel:' + this.errorCorrectLevel
          )
